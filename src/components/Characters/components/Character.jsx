            ...
            rightIconButton={
                <IconButton
                    ...
                    iconStyle={{
                        width: "20px",
                        color:
                            props.getFavIndex(props.character) !== -1
                                ? "yellow"
                                : "grey"
                    }}
                >
            ...
            <Card>
                ...
                <CardMedia>
                    ...
                    >
                        <img
                            src={
                                props.isMobile() ? props.mobile : props.desktop
                            }
                            alt={props.name}
                        />
                        <div style={{ margin: "0 2.5%", textAlign: "left" }}>
                            ...
                            <div>
                                <p>
                                    Appeared in {props.apparitionNumber} comics
                                </p>
                                <h4>First apparitions</h4>
                                <ul style={{ listStyle: "none" }}>
                                    {Object.values(
                                        props.firstThreeComicsApparitions
                                    ).map((comic, index) => {
                                        return (
                                            <li key={index}>
                                                <a
